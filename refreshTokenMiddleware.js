...
const { JWT_SECRET, JWT_EXP, REFRESH_SECRET } = require('../configs/config.js');
const extractPayload = require('../helpers/extractPayload.js');

/**
 * Refresh acess token if only access token was expired
 */
